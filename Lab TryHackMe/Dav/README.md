...
```
bibo318@parrot:~/CTFs/tryhackme/Dav$ sudo nmap -A -sS -sC -sV -O 10.10.216.70
...
```
bibo318@parrot:~/CTFs/tryhackme/Dav$ /opt/dirsearch/dirsearch.py -u 10.10.216.70 -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt -e html,php
...
bibo318@parrot:~/CTFs/tryhackme/Dav$ sudo /opt/dirsearch/dirsearch.py -u 10.10.216.70 -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt -e html,php
...
```
bibo318@parrot:~/CTFs/tryhackme/Dav$ cadaver http://10.10.216.70/webdav/
...
```
bibo318@parrot:~/CTFs/tryhackme/Dav$ nc -nlvp 9001
