...
```
bibo318@parrot:~/CTFs/tryhackme/Looking Glass$ sudo nmap -sS -sC -sV -O 10.10.161.78
...
```
bibo318@parrot:~/CTFs/tryhackme/Looking Glass$ ssh root@10.10.161.78 -o StrictHostKeyChecking=no -p 13228
...
```
bibo318@parrot:~/CTFs/tryhackme/Looking Glass$ ssh jabberwock@10.10.161.78
...
```
bibo318@parrot:~/CTFs/tryhackme/Looking Glass$ nc -nvlp 1234
...
bibo318@parrot:~/CTFs/tryhackme/Looking Glass$
```

```
bibo318@parrot:~/CTFs/tryhackme/Looking Glass$ nc -lvnp 9001
...
bibo318@parrot:~/CTFs/tryhackme/Looking Glass$ stty raw -echo
bibo318@parrot:~/CTFs/tryhackme/Looking Glass$ nc -lvnp 9001
...
`thm{65d3710e9d75d5f346d2bac669119a2312**123:))}`

2. Get the root flag.

`thm{bc2337b6f97d057b01da718ced6ead3f12**123:))}`
