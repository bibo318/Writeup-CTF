...
```
bibo318@parrot:~/CTFs/tryhackme/Poster$ sudo nmap -p- -sC -sS -sV -O 10.10.187.163
...
```
bibo318@parrot:~/CTFs/tryhackme/Poster$ msfconsole -q
...
cat /home/alison/user.txt
THM{V0N318*****postgresql_fa1l_conf1gurat1on}
...
cat /root/root.txt
THM{V0N318*****c0ngrats_for_read_the_f1le_w1th_credent1als}
