...
```
bibo318@parrot:~/CTFs/tryhackme/Develpy$ sudo nmap -A -sS -sC -sV -O -p- 10.10.120.12
...
bibo318@parrot:~/CTFs/tryhackme/Develpy$ nc 10.10.120.12 10000
...
```
bibo318@parrot:~/CTFs/tryhackme/Develpy$ nc -lvnp 4444
