...
```
bibo318@parrot:~/CTFs/tryhackme/Thompson$ sudo nmap -A -sS -sC -sV -O 10.10.27.26
...
```
bibo318@parrot:~/CTFs/tryhackme/Thompson$ sudo /opt/dirsearch/dirsearch.py -u 10.10.27.26:8080 -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt -e html,php,txt
...
```
bibo318@parrot:~/CTFs/tryhackme/Thompson$ msfconsole -q
