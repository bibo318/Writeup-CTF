...
```
bibo318@parrot:~/CTFs/tryhackme/Anonymous$ sudo nmap -p- -sS -sC -sV -Pn -O 10.10.202.0
...
```
bibo318@parrot:~/CTFs/tryhackme/Anonymous$ smbclient -L 10.10.202.0
...
```
bibo318@parrot:~/CTFs/tryhackme/Anonymous$ ftp 10.10.202.0
