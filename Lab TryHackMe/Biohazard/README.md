...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ sudo nmap -A -p- -sS -sC -sV 10.10.55.102
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ echo 'SG93IGFib3V0IHRoZSAvdGVhUm9vbS8=' | base64 -d
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ echo 'NV2XG2LDL5ZWQZLFOR5TGNRSMQ3TEZDFMFTDMNLGGVRGIYZWGNSGCZLDMU3GCMLGGY3TMZL5' | base32 -d
music_sheet{362d72deaf65f5bdc63daece6a1f676e}
```

`music_sheet{362d72deaf65f5bdc63daece6a1f676e12**123:))}`
...
`shield_key{48a7a9227cd7eb89f0a062590798cbac12**123:))}`
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ echo "Lbh trg gur oyhr trz ol chfuvat gur fgnghf gb gur ybjre sybbe. Gur trz vf ba gur qvavatEbbz svefg sybbe. Ivfvg fnccuver.ugzy" | tr '[A-Za-z]' '[N-ZA-Mn-za-m]'
...
`blue_jewel{e1d457e96cac640f863ec7bc475d48aa12**123:))}`
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ echo 'S0pXRkVVS0pKQkxIVVdTWUpFM0VTUlk9' | base64 -d | base32 -d
RlRQIHVzZXI6IG
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ echo 'GVFWK5KHK5WTGTCILE4DKY3DNN4GQQRTM5AVCTKE' | base32 -d | base58 -d
h1bnRlciwgRlRQIHBh
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ echo '' | base64 -d
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ echo 'gSUERauVpvKzRpyPpuYz66JDmRTbJubaoArM6CAQsnVwte6zF9J4GGYyun3k5qM9ma4s' | base58 -d
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ echo 'RlRQIHVzZXI6IGh1bnRlciwgRlRQIHBhc3M6IHlvdV9jYW50X2hpZGVfZm9yZXZlcg==' | base64 -d
...
`emblem{fec832623ea498e20bf4fe1821d5872712**123:))}`
...
`lock_pick{037b35e2ff90916a9abf99129c8e183712**123:))}`
...
`gold_emblem{58a8c41a9d08b8a4e38d02a4d7ff484312**123:))}`
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ ftp 10.10.55.102
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ cat important.txt
Jill,
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ steghide extract -sf 001-key.jpg
Enter passphrase:
wrote extracted data to "key-001.txt".
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ cat key-001.txt
cGxhbnQ0Ml9jYW
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ exiftool 002-key.jpg
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ exiftool 003-key.jpg
ExifTool Version Number         : 12.06
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ binwalk 003-key.jpg -e
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ cat key-003.txt
3aXRoX3Zqb2x0
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ echo -n 'cGxhbnQ0Ml9jYW5fYmVfZGVzdHJveV93aXRoX3Zqb2x0' | base64 -d
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ cat helmet_key.txt
helmet_key{458493193501d2b94bbab2e727f8db4b}
```

`helmet_key{458493193501d2b94bbab2e727f8db4b12**123:))}`
...
```
bibo318@parrot:~/CTFs/tryhackme/Biohazard$ tar xfvz doom.tar.gz
eagle_medal.txt

bibo318@parrot:~/CTFs/tryhackme/Biohazard$ cat eagle_medal.txt
