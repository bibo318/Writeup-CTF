...
```
bibo318@parrot:~/CTFs/tryhackme/Git Happens$ sudo nmap -A -sS -sC -sV -O 10.10.182.85
...
bibo318@parrot:~/CTFs/tryhackme/Git Happens$ cd git_files/
bibo318@parrot:~/CTFs/tryhackme/Git Happens/git_files$ git log 
...
```
bibo318@parrot:~/CTFs/tryhackme/Git Happens/git_files$ git show 395e087334d613d5e423cdf8f7be27196a360459
