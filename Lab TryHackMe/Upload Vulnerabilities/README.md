...
Your flag is: THM{V0N318*****OTBiODQ3YmNjYWZhM2UyMmYzZDNiZjI5}
```

`THM{V0N318*****OTBiODQ3YmNjYWZhM2UyMmYzZDNiZjI512**123:))}`
...
```
bibo318@parrot:~/CTFs/tryhackme/Upload Vulnerabilities$ gobuster dir -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -u http://shell.uploadvulns.thm
===============================================================
Gobuster v3.0.1
...
```
bibo318@parrot:~/CTFs/tryhackme/Upload Vulnerabilities$ nc -lnvp 9001
...
html
$ cat flag.txt
THM{V0N318*****YWFhY2U3ZGI4N2QxNmQzZjk0YjgzZDZk}
```
...
$ cat flag.txt
THM{V0N318*****NDllZDQxNjJjOTE0YWNhZGY3YjljNmE2}
```

1. What is the flag in /var/www/?

`THM{V0N318*****NDllZDQxNjJjOTE0YWNhZGY3YjljNmE212**123:))}`
...
html
$ cat flag.txt
THM{V0N318*****MGEyYzJiYmI3ODIyM2FlNTNkNjZjYjFl}
```

What is the flag in /var/www/?

`THM{V0N318*****MGEyYzJiYmI3ODIyM2FlNTNkNjZjYjFl12**123:))}`
...
```
bibo318@parrot:~/CTFs/tryhackme/Upload Vulnerabilities$ gobuster dir -u http://magic.uploadvulns.thm/ -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
$ cat flag.txt
THM{V0N318*****MWY5ZGU4NzE0ZDlhNjE1NGM4ZThjZDJh}
```

Grab the flag from /var/www/

`THM{V0N318*****MWY5ZGU4NzE0ZDlhNjE1NGM4ZThjZDJh12**123:))}`
...
```
bibo318@parrot:~/CTFs/tryhackme/Upload Vulnerabilities$ gobuster dir -u http://jewel.uploadvulns.thm/ -w /usr/share/wordlists/dirb/big.txt  -t 250
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
```
bibo318@parrot:~/CTFs/tryhackme/Upload Vulnerabilities$ gobuster dir -u http://jewel.uploadvulns.thm/content -w UploadVulnsWordlist.txt -t 250 -x jpg
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
html
cat flag.txt
THM{V0N318*****NzRlYTUwNTIzODMwMWZhMzBiY2JlZWU2}
```

`THM{V0N318*****NzRlYTUwNTIzODMwMWZhMzBiY2JlZWU212**123:))}`
