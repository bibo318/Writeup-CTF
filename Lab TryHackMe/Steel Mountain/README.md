...
```
bibo318@parrot:~/CTFs/tryhackme/Steel Mountain$ sudo nmap -A -sS -sC -sV -O 10.10.208.51
...
```
bibo318@parrot:~/CTFs/tryhackme/Steel Mountain$ msfconsole -q
...
```
bibo318@parrot:~/CTFs/tryhackme/Steel Mountain$ nc -lnvp 9002
