...
```
bibo318@parrot:~/CTFs/tryhackme/Inoculation$ sudo nmap -A -sC -sV -p- -O --script vuln 10.10.153.127
...
```
bibo318@parrot:~/CTFs/tryhackme/Inoculation$ nikto -h 10.10.153.127- Nikto v2.1.6
---------------------------------------------------------------------------
...
```
bibo318@parrot:~/CTFs/tryhackme/Inoculation$ ssh maynard@10.10.153.127
