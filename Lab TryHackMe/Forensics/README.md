...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 1$ vol.py -f victim.raw imageinfo
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 1$ vol.py -f victim.raw --profile=Win7SP1x64 pslist | grep SearchIndexer
Volatility Foundation Volatility Framework 2.6.1
...
```                             
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 1$ vol.py -f victim.raw --profil=Win7SP1x64 shellbags
Volatility Foundation Volatility Framework 2.6.1
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 2$ vol.py -f victim.raw --profile=Win7SP1x64 netscan
Volatility Foundation Volatility Framework 2.6.1
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 2$ vol.py -f victim.raw --profile=Win7SP1x64 malfind
Volatility Foundation Volatility Framework 2.6.1
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 3$ strings victim.raw | grep 'www.go.....ru'
www.google.ru
www.go4win.ru
www.gocaps.ru
www.goporn.ru
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 3$ strings victim.raw | grep 'www.i.....com'
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 3$ strings victim.raw | grep 'www.ic.......com'
www.icsalabs.com
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 3$ strings victim.raw | grep '202.....233....'
202.107.233.211
```
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 3$ strings victim.raw | grep '....200....164'
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 3$ strings victim.raw | grep '209.190........'
...
```
bibo318@parrot:~/CTFs/tryhackme/Forensics/Task 3$ vol.py -f victim.raw --profile=Win7SP1x64 envars | grep 2464
Volatility Foundation Volatility Framework 2.6.1
