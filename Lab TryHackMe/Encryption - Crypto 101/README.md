...
```
bibo318@parrot:~/CTFs/tryhackme/Encryption - Crypto 101$ /usr/share/john/ssh2john.py idrsa.id_rsa > idrsa.hash
bibo318@parrot:~/CTFs/tryhackme/Encryption - Crypto 101$ john idrsa.hash -w=/usr/share/wordlists/rockyou.txt
...
```
bibo318@parrot:~/CTFs/tryhackme/Encryption - Crypto 101$ gpg --import tryhackme.key
...
bibo318@parrot:~/CTFs/tryhackme/Encryption - Crypto 101$ gpg --decrypt message.gpg
